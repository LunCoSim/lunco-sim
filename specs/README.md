...
| 011 | Interactive Tutorials | Implemented | authored Rhai scenarios under `assets/tutorials`, cataloged by the application menu and launched through generic `RunScenarioAsset` + USD scene transitions; no tutorial crate or USD tutorial schema |

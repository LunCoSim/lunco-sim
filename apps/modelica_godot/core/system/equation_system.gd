...
func get_component_parameter(component_name: String, param_name: String) -> Variant:
	var component = get_component(component_name)
	if component:
		return component.get_parameter(param_name)
	return null

func set_component_parameter(component_name: String, param_name: String, value: Variant) -> void:
	var component = get_component(component_name)
	if component:

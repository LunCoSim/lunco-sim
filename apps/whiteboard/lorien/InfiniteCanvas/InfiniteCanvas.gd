...
# -------------------------------------------------------------------------------------------------
const BRUSH_STROKE = preload("res://apps/whiteboard/lorien/BrushStroke/BrushStroke.tscn")
...
func add_strokes(strokes: Array) -> void:
	...
	for stroke in strokes:
		...
		_current_project.undo_redo.add_do_method(func(): _strokes_parent.add_child(stroke))
		_current_project.undo_redo.add_do_method(func(): _current_project.add_stroke(stroke))
...
func _delete_selected_strokes() -> void:
	...
	if !strokes.is_empty():
		...
		for stroke in strokes:
			_current_project.undo_redo.add_do_method(func(): _do_delete_stroke(stroke))
			_current_project.undo_redo.add_undo_reference(stroke)
			_current_project.undo_redo.add_undo_method(func(): _undo_delete_stroke(stroke))
		_selection_tool.deselect_all_strokes()
		_current_project.undo_redo.commit_action()
		_current_project.dirty = true

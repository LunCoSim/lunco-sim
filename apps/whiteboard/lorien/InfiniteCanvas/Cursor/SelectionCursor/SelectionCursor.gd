...
const MOVE_TEXTURE = preload("res://apps/whiteboard/lorien/Assets/Cursors/move_cursor.png")
const SELECT_TEXTURE = preload("res://apps/whiteboard/lorien/Assets/Textures/selection_cursor.png")

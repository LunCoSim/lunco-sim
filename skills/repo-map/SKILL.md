...
| **Networking & API** | transport, transport-neutral replication, HTTP API, telemetry, attributes | `lunco-networking`, `lunco-networking-sync`, `lunco-api`, `lunco-telemetry-core`, `lunco-telemetry` |
...
| **Scripting & modeling** | Modelica, event-driven Rhai, tools, hooks, behavior trees, authored lessons | `lunco-modelica-core`, `lunco-modelica-ui-core`, `lunco-modelica-ui`, `lunco-scripting`, `lunco-scripting-rhai-core`, `lunco-scripting-rhai`, `lunco-tools`, `lunco-hooks`, `lunco-behavior`, `lunco-luncosim` |

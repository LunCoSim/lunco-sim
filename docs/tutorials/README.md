...
- **Shipped lessons**: 22 entries across the LunCoSim (2), Basic rover (4), Sandbox (9), and Lunica (7) tracks. Production scene gates currently cover six entries; coach/content lessons are intentionally validated by their authored objectives and anchors rather than counted as physics tests. The Welcome-panel [learning paths](../../assets/tutorials/learning_paths.json) remain a separate navigation aid.

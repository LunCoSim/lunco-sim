...
markers, collider and disabled state, plus any published support footprint. It
is a read-only diagnostic companion to `QueryEntity` and `QueryUsdPrim`; it does

...
The transport-free Modelica API surface is a separate production capability
...
complete Modelica workbench. Observers, document mutation, tab lookup, and panel
rendering remain in `lunco-modelica-ui`.

...
The reusable runtime bridge is in
`crates/lunco-workbench-runtime-ui/src/lib.rs`; the application host in
`lunco-luncosim-ui` supplies capture mode and app-specific action handling.

...
| Piece | Status |
|---|---|
| `uniform bool lunco:program:realtimeSafe`, read at prim-read time (`lunco-usd-sim-cosim/src/lib.rs`) → the `RealtimeSafe` component (`crates/lunco-cosim-core/src/connection.rs`) | **implemented** |

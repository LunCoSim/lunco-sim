...
| `ListLibrary` | `{"cursor": u64, "limit": u64, "filter": {...}}` | Search and list classes from admitted Modelica source libraries. |
...
See `crates/lunco-modelica-api/src/lib.rs` for examples and

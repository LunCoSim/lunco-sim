...
known-failing models, and the ranked rumoca / `lunco-modelica-execution` backlog. Durable
...
## Solver tuning reference — known configs, known-failing models, and the rumoca/lunco-modelica-execution backlog
...
### Outstanding tasks (lunco-modelica-execution)

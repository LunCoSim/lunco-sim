...
| **`lunco-twin`** | The simulation unit on disk: folder structure, `twin.toml` manifest parsing, generic scalar `[settings]`, explicit Twin-approved native hook-provider entries, and file indexing. |

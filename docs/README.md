...
| [`cli-reference.md`](cli-reference.md) | Command-line tool reference (flags, actions, usage) |
...
| Legacy files (top-level: `api.md`, `usd-system.md`, `gravity-architecture.md`, `web-build.md`) | To be retired or migrated into numbered architecture docs |

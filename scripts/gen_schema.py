...
USD runtime at it, and `lunco_usd_document::schema::SchemaRegistry` parses it at runtime.
...
(
    ...
    the file `lunco_usd_document::schema` parses to answer "what does this property's

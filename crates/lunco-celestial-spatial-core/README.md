...
the authored mission declarations, solar-tracking marker, and Wi-Fi endpoint
contracts consumed by USD projection and the runtime adapter. It does not
install the celestial runtime or own terrain, globe, link solving, imagery,
trajectory sampling, cadence, or asset integration.

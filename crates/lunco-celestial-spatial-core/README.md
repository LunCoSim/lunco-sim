...
the authored ephemeris-position, spacecraft-interaction, trajectory-view,
solar-tracking, and Wi-Fi endpoint contracts consumed by USD projection and
the runtime adapter. It does not install the celestial runtime or own terrain,

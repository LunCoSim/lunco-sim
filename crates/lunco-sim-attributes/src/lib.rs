...
use lunco_sim_core::architecture::{PhysicalPort, DigitalPort};

pub struct LunCoSimAttributesPlugin;

impl Plugin for LunCoSimAttributesPlugin {
...
mod tests {
    ...
    fn test_real_time_attribute_modification() {
        let mut app = App::new();
        app.add_plugins(LunCoSimAttributesPlugin);

//! Architectural marker components for the engine substrate.
//!
//! These markers carry semantic intent that low-level ECS components do not
//! express. Spatial marker components live in `lunco-spatial`; these markers
//! remain usable by headless engine consumers.

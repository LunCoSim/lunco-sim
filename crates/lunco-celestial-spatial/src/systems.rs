...
/// Recompute the camera-space solar ray when its observer or spatial frame changes.
pub fn celestial_sun_observer_needs_sync() -> impl bevy::ecs::schedule::SystemCondition<()> {
    lunco_core_runtime::gate::tracked(
        "celestial_sun_observer_needs_sync",
        celestial_sun_observer_inputs_changed,
    )
}

fn celestial_sun_observer_inputs_changed(
...
pub fn celestial_sky_sun_system(

    ...
    for gid in q_owned.iter() {
        ...
        match decision {
            ...
            lunco_core::Reconciliation::Snap {
                ...
                tf.rotation = new_rot;
                // TODO(multiplayer): this seats absolute f64 `Position` from a
                // cell-relative f32 pose (the owned compare ignores `s.cell`)
...
/// (a rover root, identified by `MobilityRoot`) and the possessed rover (`OwnedLocally`)
...
pub fn maintain_predicted_dynamic(
    ...
    q_add: Query<
        ...
        (
            ...
            //
            // `MobilityRoot` is the wheeled-vehicle discriminator. A lander/avatar

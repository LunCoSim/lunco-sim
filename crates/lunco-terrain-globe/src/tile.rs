...
/// `globe_lod` instead moves tiles into different grid cells and trips
/// `assert_dem_frame` ("DEM terrain is not grid-identity"), panicking on scene load.
/// The DEM frame assertion is coupled to the surface grid's cell layout; do not move
/// tile PLACEMENT to chase this.
///

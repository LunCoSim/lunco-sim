//! Generate the LunCoSim desktop icon from the tracked platform SVG.
//!
//! The icon is presentation and packaging output, so this build script belongs
//! to the UI crate. The headless simulator only stamps build identity and does

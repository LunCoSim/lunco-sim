...
/// Decode only the current persisted representation. Older workspace files
/// are intentionally treated as misses and rebuilt from defaults; there is no
/// runtime migration path for obsolete dock layouts.

    ...
    fn build(&self, app: &mut App) {
        app.register_type::<Suspension>()
           ...
           .add_systems(FixedUpdate, (
               ...
               // Skip on a pure client: replicated rovers are snapshot-driven
               // proxies (server-authoritative), not locally simulated.
               |tw: Res<lunco_core::TimeWarpState>, role: Res<lunco_core::NetworkRole>|
                   tw.physics_enabled && !matches!(*role, lunco_core::NetworkRole::Client)));
